...
However, this instananeous approach may bias model dynamics and outputs, such as %SM: just a minor question re: "may" in intro b/c we show the results that it "can"...? 
...
%SM: agree, i like the flow of this...
...
also grow over time.  %SM: love this explanationa and mechanistic framing and terminology!
\section{Conclusions}
Modelling sexual partnerships as instananeous can cause  %SM: and in conclusion, say "can",... b/c have shown that in the results?
...
and captures key epidemic dynamics related to partnership-level herd effects.  %SM: LOVE THIS!!!
