\section{Discussion}\label{art.disc} %SM: very nice on the re-framing! i think this captures the story nicely re: key messages. I added a few minor copy-edits only for consideration 
...
We estimated that slower ART scale-up up, reaching only \casmd by 2020, would have resulted in  %SM: nice!
6.3--18.6\,\% more cumulative infections and 68--234\,\% higher incidence in 2020. % MAN
However, we also estimated that
slower scale-up which disproportionately left behind FSW and their clients
would have led to 31--128\% mode infections that slower scale-up alone. % MAN
