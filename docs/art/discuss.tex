...
We estimated that slower but equitable ART scale-up up,
...
would have led to 31--128\% more infections than slower scale-up alone. % MAN
...
By contrast, it is alarming that recent funding disruptions to USAID and PEPFAR
