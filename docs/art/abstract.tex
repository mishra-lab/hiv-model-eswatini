...
% SM: agree (for reasons you noted)
Taking observed cascade scale-up in Eswatini as the base-case
% SM: nice (this seems clear to me re: SS comments around base-case,
%     esp with the achieved 95-95-95 among FSW in the background above)
% SM: nice and clear
% JK: thanks!
...
% SM: I think she means the left-behind-cascade X-X-X (not observed).
%     Do we (or can we) make room for these? but ok if no room (and i have a feelling will not have enough room).
% JK: yeah, it think no room here -- still 50 words over, and maybe not critical / could be confusing here?
We quantified relative additional cumulative HIV infections by 2030
% SM: trick in abstracts is that if need word count,
%     cutting these joiner words like "then/next/further, etc."
%     (although important for flow when more text allowed) often helps.
% JK: nice! Might just try submitting over the words first time and see what happens...
...
% JK: updated above per results & discussion
...
% SM: if need word count, could wordsmith and cut out "identifing and".
% JK: Got it!
