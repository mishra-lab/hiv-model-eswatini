...
% JK: this methods intro para was shortened a lot
%     since it was redundant with the last intro para
The development of the model and analyses thereof are summarized as follows.
%===================================================================================================
\subsection{Model Parameterization \& Calibration}\label{art.meth.par}
The modelled population is stratified by
HIV status, subpopulations defined by sex and sexual activity, and the ART cascade of care
...
We captured risk heterogeneity through both
subpopulation-level factors, including
...
Table~\ref{tab:art.het} summarizes
key parameter values and sampling distributions related to risk heterogeneity.
...
We parameterized the remaining subpopulations using reported data from
national studies in 2006 \cite{SDHS2006}, 2011 \cite{SHIMS1}, and 2016 \cite{SHIMS2}.
We modelled
...
except for individual-level data from FSW surveys in 2011 \cite{Baral2014} and 2014 \cite{EswKP2014},
