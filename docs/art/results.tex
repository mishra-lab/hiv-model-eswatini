...
%     in case the reader is skipping through sections (as I often do...) %SM: smort! 
...
%     I think, is this different from 'transmission within x partnerships'? %SM: agree
%     If so, does it maybe include onward transmission resulting from infections acquired within x partnerships? %SM: i like this
...
% JK: As noted above, 'were transmitted within casual partnerships' OK? %SM: agree
...
% JK: Hopefully it is more clear now re. which periods are being described in the above sentences? %SM: yes to me
...
% JK: Yeah, I do think that the 'leave behind' labels are maybe most clear %SM: yes on re-reading..
...
%     is given in the first sentence in this subsection --- does that work? %SM: n ice
...
%     I've revised to be more precise now. %SM: reads well
\begin{figure}[h]
