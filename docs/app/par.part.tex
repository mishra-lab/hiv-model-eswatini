...
As described in \sref{mod.par.pnum.sw},
...
the total numbers of sex acts per partnership and the partnership change rate (see \sref{mod.foi}).
...
As noted in \sref{mod.par.pnum.sw}, duration of occasional sex work partnerships
