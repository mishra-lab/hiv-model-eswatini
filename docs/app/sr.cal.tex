...
\sref{sr.cal.par}: posterior distributions of calibrated parameters
...
\begin{figure}
  ...
  \floatfoot{\ffpar;
    lines and circles: normalized density and means for each parameter;
    \ffast{Anderson-Darling Test \cite{Scholz1987} for comparing distributions}}
\end{figure}
\par
...
accumulation of seroconcordant partnerships (see \sref{mod.foi}).
