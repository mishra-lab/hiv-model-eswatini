%===================================================================================================
\section{Force of Infection}\label{mod.foi}
...
%===================================================================================================
\subsection{Conceptual Development}\label{mod.foi.concept}
...
but we develop the necessary equations below in \sref{mod.foi.eq}.
The issue of transmission via multiple partnerships is discussed in \sref{mod.foi.mp}.
\begin{figure}
...
\end{figure}
%===================================================================================================
\subsection{Equations}\label{mod.foi.eq}
...
As described \sref{mod.par.mix}, this ``mixing matrix'' $M_{pii'}$ can be defined in several ways,
...
%===================================================================================================
\subsection{Transmission via Multiple Partnerships}\label{mod.foi.mp}
