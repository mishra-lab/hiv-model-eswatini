...
\footnote{\eqref{eq:foi.simple} assumes
  ...
  % SM: not critical, but might help to give a definition or example for each in footnote?
  % JK: I think it is OK to cite Begon2002 instead, which defines & discusses in detail?
