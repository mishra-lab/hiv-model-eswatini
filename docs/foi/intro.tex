\section{Introduction}\label{intro} %SM: very nice!
...
\footnote{\eqref{eq:foi.simple} assumes
  frequency-dependent rather than density-dependent transmission, %SM: not critical, but might help to give a definition or example for each in footnote?
