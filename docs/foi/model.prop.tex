...
that overcomes the limitations of models \case{1-3}.
...
% JK: maybe this scenario (paragraph) can be moved to the appendix ?
...
\begin{figure}[h]
  % JK: maybe this can be moved to appendix too
