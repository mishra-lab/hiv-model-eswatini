...
% JK: should add footnote + cite about the debate around even this approach
\begin{equation}
...
and that with $\delta = 1$ as \case{1b}, which appears to be more common for HIV.
...
%(\ref{eq:foi.2a}--\ref{eq:foi.2b}) $\le$ 1.
\par
