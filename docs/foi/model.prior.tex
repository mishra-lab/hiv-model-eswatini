...
on average, more and more acts occur after transmission --- \ie are PTC.
...
and it will be useful in the new force of infection approach (\sref{foi.prop}).
%===================================================================================================
\subsection{Limitations of Prior Approaches}\label{foi.prior.lims}
The above approaches to modelling HIV transmission via sexual partnerships
...
This issue also parallels limitations of cross-sectional risk factor analyses,
