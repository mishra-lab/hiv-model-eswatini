...
\begin{figure}[h]
  \centerline{\includegraphics[width=\widefig]{B.mod.vs}}
...
\end{figure}
\begin{figure}[h]
  \centerline{\includegraphics[width=\widefig]{foi.ep.prevalence}}
...
\begin{figure}[h]
  \begin{subfigure}{\linewidth}
    \centerline{\includegraphics[width=\widefig]{inf-foi-from-rel}}
    \caption{From whom (transmitted)}
    \label{fig:inf.from}
  \end{subfigure}
  \begin{subfigure}{\linewidth}
    \centerline{\includegraphics[width=\widefig]{inf-foi-to-rel}}
...
\end{figure}
\begin{figure}[h]
  \centerline{\includegraphics[width=\widefig]{inf-base-alluvial-3}}
...
\end{figure}
\begin{figure}[h]
  \centerline{\includegraphics[width=\widefig]{foi.tpaf.33.parts}}
...
\end{figure}
\begin{figure}[h]
  \centerline{\includegraphics[width=\widefig]{foi.tpaf.33.popto}}
