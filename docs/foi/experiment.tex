...
In this section, we describe some experiments (methods and results) to
...
For simplicity, we considered a single illustrative factor $f$
...
using \emph{approach-specific} model parameters (\ie recalibrated).
...
of heterosexual HIV transmission in Eswatini \cite{Knight2023art}
...
5 stages of HIV infection and 5 stages of the HIV treatment cascade, plus
...
including Figure~\ref{fig:fit.tdsc} which illustrates
the modelled proportions of ``transmission-driven seroconcordant'' partnerships under \epa,
as described in \sref{foi.prop.tdsc}.
Appendix~\sref{sr.foi.cal} provides selected results of model calibration under all 4 approaches,
...
though overall log-likelihoods were highest under \ipy and lowest under \epa
